...
def load_model(args) -> VoxCPM:
    ...
    if getattr(args, "model_path", None):
        try:
            model = VoxCPM(
                ...
                zipenhancer_model_path=zipenhancer_path or "./model/speech_zipenhancer_ans_multiloss_16k_base",
    ...
    try:
        ...
        model = VoxCPM.from_pretrained(
            hf_model_id="./model/VoxCPM-0.5B",
            load_denoiser=not getattr(args, "no_denoiser", False),
            zipenhancer_model_id="./model/speech_zipenhancer_ans_multiloss_16k_base",
