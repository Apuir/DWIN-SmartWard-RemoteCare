...
class VoxCPM:
    def __init__(self,
            ...
            zipenhancer_model_path : str = "./model/speech_zipenhancer_ans_multiloss_16k_base",
    ...
    def from_pretrained(cls,
            hf_model_id: str = "./model/VoxCPM-0.5B",
            load_denoiser: bool = True,
            zipenhancer_model_id: str = "./model/speech_zipenhancer_ans_multiloss_16k_base",
            cache_dir: str = None,
